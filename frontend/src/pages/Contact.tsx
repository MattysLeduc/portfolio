        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="glass p-8 rounded-sm space-y-6">
                ...
                {success && (
                  <div className="p-4 bg-primary/10 border border-primary rounded-sm">
                    <p className="text-primary text-sm font-mono text-center">Message sent successfully!</p>
                  </div>
                )}
            ...
            >
              ...
              >
                <h3 className="font-display text-lg font-bold mb-4">Connect With Me</h3>
                <div className="space-y-3">
                  {socialLinks.map((social) => (
                    ...
                    >
                      ...
                      <div>
                        <p className="font-mono text-sm group-hover:text-primary transition-colors">{social.label}</p>
