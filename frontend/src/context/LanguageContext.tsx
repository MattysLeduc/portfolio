...
const translations = {
  en: {
    ...
    projectsSubtitle: "A selection of projects I've worked on, from web apps to AI tools",
    ...
    testimonialsLeaveSubtitle: 'Have worked with me? I’d love to hear about your experience!',
    testimonialsShareTitle: 'Share Your Testimonial',
    testimonialsShareSubtitle: 'Help others learn from your experience working with me',
    ...
    testimonialsSubmitSuccess: 'Testimonial submitted successfully! It will be reviewed and published shortly.',
  ...
  fr: {
    ...
    projectsSubtitle: 'Une sélection de projets web et IA sur lesquels j’ai travaillé',
    ...
    testimonialsLeaveSubtitle: 'Vous avez travaillé avec moi ? J’aimerais connaître votre avis !',
    testimonialsShareTitle: 'Partagez votre témoignage',
    testimonialsShareSubtitle: 'Aidez les autres à découvrir votre expérience de collaboration',
    ...
    testimonialsContentPlaceholder: 'Partagez votre expérience et vos impressions...',
    testimonialsContentPlaceholderFr: 'Partagez votre expérience et vos impressions...',
    testimonialsSubmit: 'Envoyer le témoignage',
    testimonialsSubmitting: 'Envoi en cours...',
    testimonialsSubmitSuccess: 'Témoignage envoyé avec succès ! Il sera bientôt examiné et publié.',
    testimonialsSubmitError: "Impossible d'envoyer le témoignage. Veuillez réessayer.",
    at: 'chez',
    contactTag: 'CONTACT',
    ...
    contactSendError: "Impossible d'envoyer le message. Veuillez réessayer plus tard.",
    ...
    loadError: 'Impossible de charger les données. Veuillez réessayer plus tard.',
    noSkills: 'Aucune compétence trouvée. Ajoutez votre première compétence pour commencer !',
    categoryFrontend: 'Frontend',
    categoryBackend: 'Backend',
    categoryDevops: 'DevOps',
    currentRole: 'Présent',
