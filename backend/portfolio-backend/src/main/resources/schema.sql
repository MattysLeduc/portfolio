...
CREATE TABLE IF NOT EXISTS testimonials (
    ...
    author_title_fr VARCHAR(200),
    company VARCHAR(255),
    author_image VARCHAR(500),
    content_en VARCHAR(2000) NOT NULL,
    content_fr VARCHAR(2000) NOT NULL,
    rating INT,
    created_at TIMESTAMP NOT NULL DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS experiences (
    ...
    company_fr VARCHAR(200) NOT NULL,
    location_en VARCHAR(200),
    location_fr VARCHAR(200),
    ...
    responsibilities_en VARCHAR(3000),
    responsibilities_fr VARCHAR(3000)
);
